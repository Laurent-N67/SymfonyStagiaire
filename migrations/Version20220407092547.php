 ...
 */
final class Version20220407092547 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE session (id INT AUTO_INCREMENT NOT NULL, formateur_id INT NOT NULL, formation_id INT NOT NULL, intitule_session VARCHAR(100) NOT NULL, date_debut DATE NOT NULL, date_fin DATE NOT NULL, nb_places_theorique INT NOT NULL, nb_places_reserve INT NOT NULL, INDEX IDX_D044D5D4155D8F51 (formateur_id), INDEX IDX_D044D5D45200282E (formation_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
